	...
	public function get_icon( $icon = 'search', $icon_title = '', $base = true, $aria = false ) {
		...
		switch ( $icon ) {
			...
			case 'spotify':
				...
				break;
			case 'flickr':
				$output .= '<svg class="kadence-svg-icon kadence-flicker-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
